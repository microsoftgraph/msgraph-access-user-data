# Demo: User profile photos and related users

This completed project is the result of the lab exercise **User profile photos and related users** that is referenced in the [README](../../README.md) in this repo.
